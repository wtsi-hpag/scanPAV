...
Files:
  ...
  yeast_data/indels_added.list 	  Long indels added to the modified assembly, simulated using the pipeline https://github.com/mlliou112/simulatesv 
  yeast_data/snps_added.list      SNPs added to the modified assembly, simulated using the pipeline https://github.com/mlliou112/simulatesv
